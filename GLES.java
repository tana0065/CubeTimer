...
public class GLES {
    ...
    public static void setLightPosition(float[] lp, float[] lp2) {
...
//        Matrix.multiplyMV(CVLightPos2, 0, cMatrix, 0, LightPos2, 0);
//        GLES20.glUniform4f(GLES.lightPosHandle2, CVLightPos2[0], CVLightPos2[1], CVLightPos2[2], 1.0f);
    }

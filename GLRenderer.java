...
public class GLRenderer implements GLSurfaceView.Renderer {
    ...
    //光源の座標　x,y,z
    private  float[] LightPos={-1f,2f,2f,1f};//x,y,z,1
    private float[] LightPos2={1.0f, -2f, -2f, 1f};
    ...
    private short[] scnumber = new short[54];

    GLRenderer(final Context context, short[] sc) {
        mContext = context;
        scnumber = sc;//色を表す0~5の番号が入っている配列
    }
...
//        GLES.setLightPosition(LightPos, LightPos2);
        ...
        for(int i = 0 ; i < 54 ; i++){
            ...
            switch (scnumber[i]){
                case 0:
                    MyCube.draw(1f, 1f, 1f, 1f, 20.f, i);//白を描画
                    break;
                case 1:
                    MyCube.draw(1f, 0.5f, 0f, 1f, 20.f, i);//オレンジを描画
                    break;
                case 2:
                    MyCube.draw(1f, 1f, 0f, 1f, 20.f, i);//黄色を描画
                    break;
                case 3:
                    MyCube.draw(1f, 0f, 0f, 1f, 20.f, i);//赤を描画
                    break;
                case 4:
                    MyCube.draw(0f, 1f, 0f, 1f, 20.f, i);//緑を描画
                    break;
                case 5:
                    MyCube.draw(0f, 0f, 1f, 1f, 20.f, i);//青を描画
                    break;
